...
function send_mobile_sms($phone, $messageOtp){
    ...
    if ($response->successful()) {
        ...
        $responseData = $response->json(); // Access JSON response body
        
        return $responseData;
        
    } else {
        // Handle failed response
        $statusCode = $response->status(); // Get status code
        $errorMessage = $response->body(); // Get response body
        return $statusCode.'/error message .'.$errorMessage;
